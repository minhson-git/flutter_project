...
class AppTheme {
  ...
  static const Color primaryLight = Color(0xFFDC143C); // Deep crimson
  static const Color primaryVariantLight =
  Color(0xFF8B0000); // Darker red variant
  static const Color secondaryLight =
  Color(0xFF8B0000); // Darker red for secondary
  static const Color secondaryVariantLight = Color(0xFF8B0000);
  static const Color backgroundLight = Color(0xFF0A0A0A); // True black
  static const Color surfaceLight = Color(0xFF1A1A1A); // Dark gray for cards
  static const Color surfaceVariantLight =
  Color(0xFF2A2A2A); // Lighter surface tone
  ...
  static const Color onBackgroundLight = Color(0xFFE5E5E5); // Soft white
  static const Color onSurfaceLight = Color(0xFFCCCCCC); // Medium gray
  static const Color onErrorLight = Color(0xFFFFFFFF);
  static const Color outlineLight = Color(0xFF404040); // Subtle gray

  // Dark theme colors (same as light for this dark-first design)
  static const Color primaryDark = Color(0xFFDC143C);
  static const Color primaryVariantDark = Color(0xFF8B0000);
  static const Color secondaryDark = Color(0xFF8B0000);
  static const Color secondaryVariantDark = Color(0xFF8B0000);
  ...
  // Shadow colors (minimal for dark theme)
  ...
  static const Color textHighEmphasisLight = Color(0xFFE5E5E5); // 90% opacity
  static const Color textMediumEmphasisLight = Color(0xFFCCCCCC); // 80% opacity
  static const Color textDisabledLight = Color(0xFF808080); // 50% opacity

  static const Color textHighEmphasisDark = Color(0xFFE5E5E5);
  static const Color textMediumEmphasisDark = Color(0xFFCCCCCC);
  static const Color textDisabledDark = Color(0xFF808080);

  /// Light theme (actually dark for streaming app)
  static ThemeData lightTheme = ThemeData(
    ...
    colorScheme: ColorScheme(
      ...
      shadow: shadowLight,
      scrim: shadowLight,
      inverseSurface: surfaceVariantLight,
  ...
  /// Dark theme (same as light for this streaming app design)
  ...
  static TextTheme _buildTextTheme({required bool isLight}) {
    ...
    return TextTheme(
      ...
      // Label styles - Inter for captions and JetBrains Mono for data
